...
class UploadNgoFile extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UploadNgoFile> createState() => _UploadNgoFileState();
}

class _UploadNgoFileState extends ConsumerState<UploadNgoFile> {
      ...
      children: [
        ...
        Consumer(
          builder: (context, ref, child) {
            ...
            final droppedFile = ref.watch(
              ngoRegProvider.select((v) => v.droppedFile),
            );
            if (droppedFile != null) {
              return Container(
  ...
  void _removeFile() {
    if (_isDisposed || !mounted) return;
    ref.read(ngoRegProvider.notifier).setDroppedFile(null);
