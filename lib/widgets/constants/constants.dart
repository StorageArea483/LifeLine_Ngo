...
// Color Constants
const Color softBackground = Color(0xFFF7E8EC);
const Color accentRose = Color(0xFFC57C8A);
const Color primaryMaroon = Color(0xFF732C3F);
const Color darkCharcoal = Color(0xFF1A0B12);
const Color lightText = Color(0xFF6B7A90);
