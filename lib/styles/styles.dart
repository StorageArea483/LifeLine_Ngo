...
class AppColors {
  // Claude Web Theme Colors
  // Background - warm off-white like Claude
  static const Color softBackground = Color(0xFFFAFAF8);
  static const Color surfaceLight = Color(0xFFFFFFFF);
  static const Color cardBackground = Color(0xFFFFFFFF);

  // Primary - burnt orange/coral (Claude's signature accent)
  static const Color primary = Color(0xFFD97757);
  static const Color primaryMaroon = Color(0xFFD97757); // Legacy alias
  static const Color accentRose = Color(0xFFD97757); // Legacy alias
  static const Color accent = Color(0xFFD97757);

  // Text colors - near black and warm grays
  static const Color darkCharcoal = Color(0xFF1A1A1A);
  static const Color textPrimary = Color(0xFF1A1A1A);
  static const Color textSecondary = Color(0xFF6B6860);
  static const Color textLight = Color(0xFF8A8479);
  static const Color textFooter = Color(0xFF8A8479);
  static const Color textMuted = Color(0xFFA8A29E);

  // Border and divider colors - soft warm gray
  static const Color borderColor = Color(0xFFE5E2DC);
  static const Color borderLight = Color(0xFFF0EDE7);
  static const Color shadowLight = Color(0x0A000000);
  static const Color overlay = Color(0x801A1A1A);

  // Status colors - refined for warm theme
  ...
  static const Color primaryBlue = Color(0xFFD97757);
}
...
class AppDecorations {
  ...
  static const LinearGradient pageLinearGradient = LinearGradient(
    ...
    colors: [AppColors.softBackground, AppColors.softBackground],
  );
}
